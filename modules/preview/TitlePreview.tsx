...
export function TitlePreview({ data }: { data: TitleData }) {
  ...
  return (
    <div style={{ ...moduleSurface(data.backgroundColor), position: 'relative', overflow: 'hidden', padding: '12px 24px 4px', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', ...bgStyle }}>
