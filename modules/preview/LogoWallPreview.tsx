...
export function LogoWallPreview({ data }: { data: LogoWallData }) {
  ...
  return (
    <section style={{ background: data.backgroundColor || '#ffffff', padding: isMobile ? '48px 16px' : '64px 24px', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
