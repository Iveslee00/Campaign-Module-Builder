...
export function StickySidebarPreview({ data }: { data: StickySidebarData }) {
  ...
  return (
    <div style={{ background: 'linear-gradient(180deg, #ffffff, #f8fafc)', padding: '28px', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', minHeight: '120px', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: isRight ? 'flex-end' : 'flex-start' }}>
        ...
        {data.items.map((item, i) => (
          <div
            ...
            style={{
              ...
              borderRadius: i === 0 ? (isRight ? '14px 0 0 0' : '0 14px 0 0') : i === data.items.length - 1 ? (isRight ? '0 0 0 14px' : '0 0 14px 0') : '0',
              whiteSpace: 'nowrap',
